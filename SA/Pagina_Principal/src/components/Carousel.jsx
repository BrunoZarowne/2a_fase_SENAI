...
function Carousel() { 
  ...
  return (
    <div className='containerCarousel'>
      <button className='buttonAdc' onClick={adcImagens}>Postar</button>
     ...
     <Modal
      ...
      >
        ...
        <button className='buttonCloseModal' onClick={fecharModal}><img src="./fechar_modal.svg"/></button>
          <div className='inputsUm'>
            ...
            <div className='caixaSinopse'>
                ...
                <button className='buttonPostar' type="submit" onClick={guardar_infos_postagem}>Postar</button>
            </div>
        </div>
      </Modal>
    </div>
